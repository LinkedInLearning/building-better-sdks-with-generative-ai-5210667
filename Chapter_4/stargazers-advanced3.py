"""GitHub Stars API client with PEP-8 compliance.

This module provides classes for interacting with GitHub's API,
specifically focused on star and stargazer operations.
"""
...
class GitHubAPIClient:
    ...
    Handles authentication, error handling, and retry logic for GitHub API requests.
    """
    ...
    def _make_request(
        ...
        raise requests.exceptions.RequestException(
            "Max retries exceeded with no successful response"
        )
...
class GitHubStarsClient:
    ...
    def export_stargazers(
        ...
        return self.api.get_raw(
            endpoint,
            params=params,
            accept_format=accept_format,
        )
    
    def get_user_star_recommendations(
        self,
...
if __name__ == "__main__":
    ...
    # List repositories starred by a user
    starred_repos = client.list_starred_repositories(
        "octocat", per_page=5, sort="updated"
    )
