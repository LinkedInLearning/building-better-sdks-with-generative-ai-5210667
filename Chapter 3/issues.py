...
class GitHubIssuesAPI(GitHubAPI):
...
if __name__ == "__main__":
    ...
    # Using GitHubIssuesAPI
    github_issues = GitHubIssuesAPI(token)
    new_issue = github_issues.create_issue("octocat", "Hello-World", "New issue title", "Issue body")
    print(new_issue)
    issues = github_issues.list_issues("octocat", "Hello-World")
    print(issues)